...
export const Phd: React.FC = () => (
	<>
		...
		<div>
			...
			-- Pelinski, T., Caspe, F., McPherson, A. & Sandler, M. (2023). Computing ecosystems: Neural networks and embedded hardware platforms. In CHI2023 Workshop [WS2] - Beyond Prototyping
			Boards: Future Paradigms for Electronics Toolkits. Hamburg, Germany. <a href='https://electrofab.prototyping.id/assets/papers/electrofab23-final82.pdf'>paper</a> <br />
			-- Pelinski, T., Díaz, R., Benito Temprano, A. L. & McPherson, A. (2023). Pipeline for recording datasets and running neural networks on the Bela embedded hardware platform. in Proceedings
			of the International Conference on New Interfaces for Musical Expression Mexico City, Mexico. <a href='/documents/2023-nime-cr-pipeline-nn-bela.pdf'>paper</a>{' '}
		...
		<div>
			...
			-- 28-06-2022 co-organising the <a href='https://embedded-ai-for-nime.github.io/'>embedded ai workshop</a> at the <a href='https://nime2022.org/'>nime 2022</a> conference
			<br />
			-- 30-06-2022 presenting my research at the <a href='https://nime2022.org/'>nime 2022</a> doctoral consortium
			<br />
			...
			-- 23-09-2023 being interviewed at the bela blog:{' '}
			...
			-- 27-09-2022 giving an invited talk on digital musical instruments at the <a href='/documents/2022-ucm-organologia.pdf'> 1st organoloy workshop</a> at the universidad complutense de
			madrid -- <a href='https://youtu.be/kZxsD32a7T0?t=1739'>video</a> (spanish)
			<br />
			-- 22-11-2022 giving a talk "
			<a href='https://www.uio.no/ritmo/english/news-and-events/events/workshops/2022/embodied-ai/p/teresa-pelinski.html'>
				anomaly detection as means of sensing subtletly and nuance in musical gesture
			</a>
		...
		<div>
			...
			-- 09-2021:09-2025 phd studentship - EPSRC UKRI Centre for Doctoral Training in Artificial Intelligence and Music (EP/S022694/1) at Queen Mary University of London <br />
			-- 04-2023:10-2023 internship at <a href='https://bela.io/'>bela</a> <br />
			-- 10-2023:09-2024 <a href='https://www.turing.ac.uk/work-turing/studentships/enrichment'>turing enrichment scheme</a> at <a href='https://www.turing.ac.uk/'>the alan turing institute</a>{' '}
			<br />
			<div>
				<span className='h-yellow'>teaching / demonstrating</span>: <br />
				-- 01-2022:05-2022 demonstrator (interaction design, undergraduate module, ECS6012) at queen mary university of london <br />
				-- 06-2022:07-2022 teaching associate (interactive media design and production, undergraduate module, EBU6305) at queen mary university of london <br />
				-- 10-2022:12-2022 associate lecturer (natural language processing for the creative industries, master level module, IU000131) at university of the arts london <br />
				-- 03-2022 two invited lectures (artificial intelligence for the media, master level module, IU000133) at university of the arts london <br />
			</div>
		</div>
	</>
)
