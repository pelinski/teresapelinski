...
export const Art: React.FC = () => (
	<>
		<span className='screen-title'>sound</span>
		<div>
			<span className='h-yellow'>phonos foundation residency</span>: <br />
			<div>
			...
			<div>
				...
				when i die? in the process of digitalising the recordings, i listened todolellanos' voices and a voice i had long not heard, my dad's. this project is about many things, but mainly
				about listening. i feel the warmth of my dad's voice, and recognise some of the todolellanos' voices – i met some of them when i was a kid. and i wonder who am i listening to when i
		...
		<div>
			<span className='h-yellow'>radio show -- Officium</span>: <br />
			<br />
			"Adam Barkley and Teresa Pelinski's Saturday morning service on <a href='https://www.noodsradio.com/'>Noods Radio</a>, Officium, spans an all-encompassing range of sacred and devotional
			musics to ease those aching souls. Expect twelfth-century chants, transcendental minimalism and a deep dive into contemporary and classical choral goodness." (links coming soon!)
		</div>
		{/* <div>
			<span className='h-yellow'>gigs</span>: <br />
		</div> */}
	</>
)
