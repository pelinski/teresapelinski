...
export const Art: React.FC = () => (
	<>
		...
		<div>
			i generated the artificial voice in 'no shell, just a voice' using a couple of hours of my dad's field recordings and wavenet, a neural audio synthesis deep learning model. my dad, ramón pelinski, was an ethnomusicologist, and he studied the sword dance at la todolella, a small village close to castellón, in eastern spain. in these tapes, recorded during the 90s, he interviews the old and the young who inhabit la todolella, and asks them about how their lives have changed over time and how cultural identity is represented through music. i found these tapes in a wooden mountain of boxes in his office. my dad does not live anymore, and i wonder if these tapes will ever be listened to again. will someone just throw them away when i die? in the process of digitalising the recordings, i listened todolellanos' voices and a voice i had long not heard, my dad's. this project is about many things, but mainly about listening. i feel the warmth of my dad's voice, and recognise some of the todolellanos' voices – i met some of them when i was a kid. and i wonder who am i listening to when i listen to the artificial voice. do voices always point to someone? can they point to more than one person? i discuss the question of the body in artificial voices considering mladen dolar, michel chion and pierre schaeffer's accounts on the voice in the webzine accompanying this work (<a href='https://noshell.teresapelinski.com/'>noshell.teresapelinski.com</a>). the first track is an archive (dataset) sample. the second track is the generated voice. finally, the last track collects the algorithm-generated voices during training in ascending order (i.e., the algorithm learns to
